...
def shortest_path(source, target):  # inputs are person ids
    """
    ...
    while True:
        # If nothing in frontier, no path
        if frontier.empty():
        ...
        # If person is the target, return a list of (movie, person)
        solution = []
        ...
        # Add person to the explored set
